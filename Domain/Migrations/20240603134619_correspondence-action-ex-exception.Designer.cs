...
namespace Domain.Migrations
{
    ...
    [Migration("20240603134619_correspondence-action-ex-exception")]
    partial class correspondenceactionexexception
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.AuthorityException", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.CorrespondenceSource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CorrespondenceSources");
                });
            ...
            modelBuilder.Entity("Domain.Models.ExternalException", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.TaskAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.AuthorityException", b =>
                {
                    b.HasOne("Domain.Models.UserOrgUnit", "CreatedByUser")
                        .WithMany("AuthorityExceptionCreate")
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Models.OrgUnit", "OrgUnit")
                        .WithMany("AuthorityExceptions")
                        .HasForeignKey("OrgUnitId")
                        .IsRequired()
                        .HasConstraintName("FK_AuthorityExceptions_OrgUnits");

                    b.HasOne("Domain.Models.UserOrgUnit", "UpdatedByUser")
                        .WithMany("AuthorityExceptionUpdate")
                        .HasForeignKey("UpdatedBy")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Domain.Models.CorrespondenceSource", b =>
                {
                    b.HasOne("Domain.Models.UserOrgUnit", "CreatedByUser")
                        .WithMany("CorrespondenceSourceCreate")
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Models.UserOrgUnit", "UpdatedByUser")
                        .WithMany("CorrespondenceSourceUpdate")
                        .HasForeignKey("UpdatedBy")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Domain.Models.ExternalException", b =>
                {
                    b.HasOne("Domain.Models.UserOrgUnit", "CreatedByUser")
                        .WithMany("ExternalExceptionCreate")
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Models.OrgUnit", "OrgUnit")
                        .WithMany("ExternalExceptions")
                        .HasForeignKey("OrgUnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Models.UserOrgUnit", "UpdatedByUser")
                        .WithMany("ExternalExceptionUpdate")
                        .HasForeignKey("UpdatedBy")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Domain.Models.TaskAction", b =>
                {
                    b.HasOne("Domain.Models.UserOrgUnit", "CreatedByUser")
                        .WithMany("TaskActionsCreate")
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Domain.Models.UserOrgUnit", "UpdatedByUser")
                        .WithMany("TaskActionsUpdate")
                        .HasForeignKey("UpdatedBy")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Domain.Models.OrgUnit", b =>
                {
                    b.Navigation("AuthorityExceptions");

                    b.Navigation("ExternalExceptions");
            ...
            modelBuilder.Entity("Domain.Models.UserOrgUnit", b =>
                {
                    ...
                    b.Navigation("AuthorityExceptionCreate");

                    b.Navigation("AuthorityExceptionUpdate");
                    ...
                    b.Navigation("CorrespondenceSourceCreate");

                    b.Navigation("CorrespondenceSourceUpdate");
                    ...
                    b.Navigation("ExternalExceptionCreate");

                    b.Navigation("ExternalExceptionUpdate");
                    ...
                    b.Navigation("TaskActionsCreate");

                    b.Navigation("TaskActionsUpdate");
